...
import { hasLocation, hasCoordinates, locationText } from '../../domain/entities/video';
  ...
  return (
    <TouchableOpacity style={styles.card} onPress={() => openVideo(video.id)} activeOpacity={0.7}>
      <Image
        ...
        placeholder={{ uri: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mN8/+F/PQAJpAN4mee+1AAAAABJRU5ErkJggg==' }}
        contentFit="cover"
      />
